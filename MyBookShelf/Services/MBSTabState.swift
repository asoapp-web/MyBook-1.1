...
/// Shared observable that screens write to and the tab bar reads from.
@MainActor
final class MBSTabState: ObservableObject {
    ...
    // MARK: - Screen-driven flags the tab bar reacts to
...
// MARK: - View modifier to push overlay depth on appear/disappear
