//
//  MBSAtmosphereBackground.swift
//  MyBookShelf
//

import SwiftUI

/// Full-screen layered atmosphere: warm-ink base, animated amber glow orbs,
/// diagonal sheen, edge vignette, and static film grain. Respects accessibility.
...
private struct MBSAtmosphereGlowLayer: View {
    ...
    var body: some View {
        ZStack {
            // Primary amber lantern — top right, breathes
            Circle()
                .fill(
                    RadialGradient(
                        colors: [
            ...
            // Secondary warm ink orb — bottom left, counter-breathes
            Circle()
                .fill(
                    RadialGradient(
                        colors: [
            ...
            // Mid amber accent — centre-bottom
            Ellipse()
                .fill(
                    RadialGradient(
                        colors: [
            ...
            // Faint centre-top crown — anchors the navbar zone
            Ellipse()
                .fill(
                    RadialGradient(
                        colors: [
...
// MARK: - Film grain (hash-based, stable, cheap)
...
// MARK: - Scroll surface helper

extension View {
    /// Hides the system scroll background so the atmosphere shows through Lists and Form.
    @ViewBuilder
